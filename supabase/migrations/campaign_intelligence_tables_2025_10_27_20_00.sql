...
CREATE POLICY "Users can manage their campaign intelligence" ON campaign_intelligence_2025_10_27_20_00
  FOR ALL USING (auth.uid() = user_id);

-- Campaign Documents Policies  
CREATE POLICY "Users can manage their campaign documents" ON campaign_documents_2025_10_27_20_00
  FOR ALL USING (auth.uid() = user_id);

-- AI Response Log Policies
CREATE POLICY "Users can manage their AI response log" ON ai_response_log_2025_10_27_20_00
  FOR ALL USING (auth.uid() = user_id);